...
$query_select = "SELECT Comenzi_robot.ID_COMANDA,Comenzi_robot.MOD_CONTROL,Comenzi_robot.DATA_FUNCTIONARII,Comenzi_robot.STATUS_COMENZI,Date_pacient.NUME, Date_pacient.PRENUME FROM Date_pacient INNER JOIN Comenzi_robot ON Date_pacient.ID_PACIENT=Comenzi_robot.ID_PACIENT AND Comenzi_robot.ID_MEDIC='{$_SESSION['Id']}'";
...
<html>
  <head>
  	<title>ROBOMED | Transporturi</title>
    <meta charset="utf-8">
  ...
  <body>
      ...
      <div id="content" class="p-md-0 p-sm-0">
        ...
        <h1 class="titleVP"><i class="fa fa-ambulance meniu-iconsr"></i> Transporturi de medicamente <i class="fa fa-ambulance meniu-icons"></i></h1>
		<?php 
            ...
            <table class="table">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th scope="col">Mod Control</th>
                      <th scope="col">Data Functionarii</th>
                      <th scope="col">Status comenzi</th>
                    </tr>
                  </thead>
                  <tbody id="myTable">
                  ...
                  <?php
                   ...
                   while($row=mysqli_fetch_assoc($result_select)){
					  ...
					  echo "<td>".$row['MOD_CONTROL']."</td>";
                      echo "<td>".$row['DATA_FUNCTIONARII']."</td>";
                      echo "<td>".$row['STATUS_COMENZI']."</td>";
