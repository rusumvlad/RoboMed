...
<html>
  <head>
  	<title>ROBOMED | Vizualizare pacienti</title>
    <meta charset="utf-8">
            ...
            <table class="table">
                  ...
                  <tbody id="myTable">
                   ...
                   while($row=mysqli_fetch_assoc($result_select)){
					  ...
					  echo "<td colspan='3'>";?><a href="edit_pacienti.php?id=<?php echo $row['ID_PACIENT']; ?>"><button type='button' class='btn btn-danger'>Edit/Info</button></a>
					  <a href="delete_pacienti.php?id=<?php echo $row['ID_PACIENT']; ?>"><button type='button' class='btn btn-danger'>Delete</button></a>
					  <a href="adauga_tratament_comanda.php?id=<?php echo $row['ID_PACIENT']; ?>"><button type='button' class='btn btn-danger'>Adauga tratament</button></a>
